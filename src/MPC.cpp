...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  //limiting values of steering from -25 to 25 degrees (values given in radians)
  double angle_lim = 25;
  double angle_lim_rad = angle_lim*3.14159/180;
  double mod_angle = angle_lim_rad*Lf;
  for (size_t i= delta_start; i<a_start; i++){
    vars_lowerbound[i] = -mod_angle;
    vars_upperbound[i] = mod_angle;
  }
